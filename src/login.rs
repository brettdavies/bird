...
/// embedded xurl crate. Mirrors [`run_oauth2_authenticate_headless`] except
/// the step-1 and step-2 calls go through `xurl::auth::Auth` directly
/// rather than spawning `xr auth oauth2 --no-browser --step ...`.
